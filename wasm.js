...
const Chip8WasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chip8wasm_free(ptr >>> 0));
/**
*/
export class Chip8Wasm {
    ...
    */
    tick() {
        wasm.chip8wasm_tick(this.__wbg_ptr);
    }
    /**
    */
    tick_timers() {
        wasm.chip8wasm_tick_timers(this.__wbg_ptr);
    }
    /**
    */
    reset() {
        wasm.chip8wasm_reset(this.__wbg_ptr);
    }
    /**
    ...
    */
    keypress(event, pressed) {
        wasm.chip8wasm_keypress(this.__wbg_ptr, addHeapObject(event), pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load_rom(data) {
        wasm.chip8wasm_load_rom(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @param {number} scale
    */
    draw_screen(scale) {
        wasm.chip8wasm_draw_screen(this.__wbg_ptr, scale);
    }
}

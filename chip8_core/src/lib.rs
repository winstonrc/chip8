...
impl Chip8 {
    ...
    fn execute(&mut self, op: u16) {
        ...
        match (digit1, digit2, digit3, digit4) {
            ...
            // DRAW
            (0xD, _, _, _) => {
                // Get the (x, y) coordinates for the sprite.
                ...
                for y_line in 0..num_rows {
                    ...
                    for x_line in 0..8 {
                        // Use a mask to fetch the current pixel's bit.
                        // Only flip if it's a 1.
                        if (pixels & (0b1000_0000 >> x_line)) != 0 {
                            // Sprites should wrap around the screen, so apply
                            // modulo.
            ...
            // This is designed with readability over performance and is an area that
            // could be optomized.
            (0xF, _, 3, 3) => {
                let x = digit2 as usize;
                let vx = self.v_reg[x] as f32;

                // Fetch the hundreds digit by dividing by 100 and tossing the
                // decimal.
                let hundreds = (vx / 100.0).floor() as u8;
                // Fetch the tens digit by dividing by 10 and tossing the ones
                // digit and the decimal.
                let tens = ((vx / 10.0) % 10.0).floor() as u8;

                // Fetch the ones digit by tossing the hundreds and tens digits.
            ...
            (_, _, _, _) => unimplemented!("Unimlemented opcode: {}", op),
        }
    }
